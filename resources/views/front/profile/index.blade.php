    ...
    <div class="container">
      <div class="user-profile-section">
        ...
        <div class="user-dashboard">
          <div
            class="nav nav-item nav-pills me-3"
            id="v-pills-tab"
            role="tablist"
          ...
          >
            ...
            >
              ...
              <span class="text"> Parsonal Info </span>
            </button>
            <button
              class="nav-link"
          ...
          >
                            ...
                            <div class="info-details">
                              ...
                              <p>
                                <a
                                  ...
                                  class="__cf_email__"
                                  data-cfemail="cbafaea6a4aea6aaa2a78baca6aaa2a7e5a8a4a6"
                                  >[email&#160;protected]</a
                                >
                              </p>
                              <p>023 434 54354</p>
                            ...
                            <div class="info-details">
                              ...
                              <p>
                                <a
                                  href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                  class="__cf_email__"
                                  data-cfemail="2a4e4f47454f474b43466a4d474b434604494547"
                                  >[email&#160;protected]</a
                                >
                              </p>
                              <p>023 434 54354</p>
                      ...
                      <div class="review-form">
                        <div class="account-inner-form">
                          <div class="review-form-name">
                            <label for="firname" class="form-label"
                              >First Name*</label
                            >
                            <input
                              type="text"
                        ...
                        <div class="account-inner-form city-inner-form">
                          <div class="review-form-name">
                            <label for="teritory" class="form-label"
                              >Town / City*</label
                            >
                        ...
                        <div class="submit-btn">
                          ...
                          <a href="#" class="shop-btn update-btn"
                            >Update Profile</a
                          >
                        </div>
                      </div>
            ...
            >
              <div class="payment-section">
                ...
                <div class="wrapper-btn">
                  <a href="#" class="shop-btn" onclick="modalAction('.cart')"
                    >Add Cart</a
                  >
                  ...
                  <div class="modal-wrapper cart">
                    ...
                    <div class="login-section account-section modal-main">
                      <div class="review-form">
                        ...
                        <div class="review-form-name address-form">
                          <label for="cnumber" class="form-label"
                            >Card Number*</label
                          >
                          <input
                            type="number"
                    ...
                    <div class="login-section account-section modal-main">
                      <div class="review-form">
                        ...
                        <div class="account-inner-form">
                          ...
                          <div class="review-form-name">
                            <label for="ipscode" class="form-label"
                              >IPSC Code</label
                            >
                            <input
                              type="number"
                        ...
                        <div class="info-details">
                          ...
                          <p>
                            <a
                              href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                              class="__cf_email__"
                              data-cfemail="791d1c14161c14181015391e14181015571a1614"
                              >[email&#160;protected]</a
                            >
                          </p>
                          <p>023 434 54354</p>
                        ...
                        <div class="info-details">
                          ...
                          <p>
                            <a
                              href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                              class="__cf_email__"
                              data-cfemail="ec8889818389818d8580ac8b818d8580c28f8381"
                              >[email&#160;protected]</a
                            >
                          </p>
                          <p>023 434 54354</p>
                      ...
                      <div class="login-section account-section modal-main">
                        <div class="review-form">
                          ...
                          <div class="account-inner-form city-inner-form">
                            ...
                            <div class="review-form-name">
                              <label for="usernumber" class="form-label"
                                >Postcode / ZIP*</label
                              >
                              <input
                                type="number"
                  ...
                  <div class="form-section">
                    <form action="#">
                      <div class="currentpass form-item">
                        <label for="currentpass" class="form-label"
            ...
            >
              <div class="support-ticket">
                <a href="#" class="shop-btn" onclick="modalAction('.ticket')"
                  >Add New Support</a
                >
                ...
                <div class="modal-wrapper ticket">
                  ...
                  <div class="login-section account-section modal-main">
                    <div class="review-form">
                      ...
                      <div class="account-inner-form">
                        <div class="review-form-name">
                          <label for="ticketaddress" class="form-label"
                            >Email Address*</label
                          >
                          <input
                            type="email"
                        ...
                        <div class="review-form-name">
                          <label for="ticketphone" class="form-label"
                            >Phone Number*</label
                          >
                          <input
                            type="tel"
                      ...
                      <div class="review-form-name address-form">
                        <label for="ticketmassage" class="form-label"
                          >Description*</label
                        >
                        <textarea
                          name="ticketmassage"
