        ...
        <div class="swiper hero-swiper">
            <div class="swiper-wrapper hero-wrapper">
                @foreach ($sliders as $slider)
                    <div class="swiper-slide hero-slider-one" style="background-image: url({{ $slider->Image() }})">
                        <div class="container">
                            <div class="col-lg-6">
                ...
                <div class="row gy-4 gx-5 gy-lg-0">
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right"
                            style="background-image: url({{ asset('assets/front/') }}/assets/images/homepage-one/syle-bg-one.webp)">
                            <div class="wrapper-info">
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-two" data-aos="fade-up"
                            style="background-image: url({{ asset('assets/front/') }}/assets/images/homepage-one/style-bg-two.webp)">
                            <div class="wrapper-info">
        ...
        <section class="product flash-sale">
            <div class="container">
                ...
                <div class="flash-sale-section">
                    <div class="row g-5">
                        @foreach ($flashProductsWithTimer as $item)
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/') }}/assets/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img" />
                                <div class="product-cart-items">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/') }}/assets/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img" />
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/') }}/assets/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img" />
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/') }}/assets/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img" />
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/') }}/assets/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img" />
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/') }}/assets/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img" />
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
