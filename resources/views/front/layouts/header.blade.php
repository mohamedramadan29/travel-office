<header id="header" class="header">
    ...
    <div class="header-center-section d-none d-lg-block">
      <div class="container">
        <div class="header-center">
          <div class="logo">
            <a href="index-2.html">
              <img src="{{ $setting->getLogoAttribute() }}" alt="logo" />
            </a>
          </div>
                ...
                <div class="cart-wrapper-item">
                  <div class="wrapper">
                    <div class="wrapper-item">
                      <div class="wrapper-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-1.webp"
                          alt="img"
                        />
                      </div>
                  ...
                  <div class="wrapper">
                    <div class="wrapper-item">
                      <div class="wrapper-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-2.webp"
                          alt="img"
                        />
                      </div>
                      <div class="wrapper-content">
                  ...
                  <div class="wrapper">
                    <div class="wrapper-item">
                      <div class="wrapper-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-3.webp"
                          alt="img"
                        />
                      </div>
                      <div class="wrapper-content">
                  ...
                  <div class="wrapper">
                    <div class="wrapper-item">
                      <div class="wrapper-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/product-img/product-img-4.webp"
                          alt="img"
                        />
                      </div>
                      <div class="wrapper-content">
    ...
    <nav class="mobile-menu d-block d-lg-none">
      <div
        class="mobile-menu-header d-flex justify-content-between align-items-center"
      >
        <button
          class="btn"
          type="button"
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/dresses.webp"
                          alt="dress"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/bags.webp"
                          alt="Bags"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/sweaters.webp"
                          alt="sweaters"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/shoes.webp"
                          alt="sweaters"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/gift.webp"
                          alt="gift"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/sneakers.webp"
                          alt="sneakers"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/watch.webp"
                          alt="watch"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/ring.webp"
                          alt="ring"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/cap.webp"
                          alt="cap"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/glass.webp"
                          alt="glass"
                        />
                      </span>
                ...
                <a href="product-sidebar.html">
                  ...
                  >
                    <div class="dropdown-list-item d-flex">
                      <span class="dropdown-img">
                        <img
                          src="{{ asset('assets/front') }}/assets/images/homepage-one/category-img/baby.webp"
                          alt="baby"
                        />
                      </span>
