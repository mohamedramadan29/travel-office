    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title"
                        ...
                        class="float-right mr-2 badge badge-info badge-pill">3</span></a>
            ...
            @can('roles')
                <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                            data-i18n="nav.templates.main"> ادارة الصلاحيات </span></a>
                    <ul class="menu-content">
                        <li>
                        <li><a class="menu-item" href="{{ route('dashboard.roles.index') }}"
                                data-i18n="nav.templates.vert.classic_menu"> جميع الصلاحيات </a>
                        </li>
                        <li><a class="menu-item" href="{{ route('dashboard.roles.create') }}"> اضافة صلاحية </a>
                        </li>
                </li>
            @endcan
        </ul>
