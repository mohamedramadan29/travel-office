                ...
                <ul class="float-left mr-auto nav navbar-nav">
                    ...
                    <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#"
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                <h6 class="mb-1 dropdown-menu-header text-uppercase"><i class="la la-newspaper-o"></i>
                                    News</h6>
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="mb-1 rounded img-fluid"
                                            src="{{ asset('assets/admin/') }}/images/slider/slider-2.png"
                                            alt="First slide"><a class="mb-0 news-title" href="#">Poster
                                            Frame PSD</a>
                            ...
                            <li class="col-md-3">
                                ...
                                <div id="accordionWrap" role="tablist" aria-multiselectable="true">
                                    <div class="border-0 card box-shadow-0 collapse-icon accordion-icon-rotate">
                                        <div class="p-0 pb-2 border-0 card-header" id="headingOne" role="tab"><a
                                        ...
                                        <div class="p-0 pb-2 border-0 card-header" id="headingTwo" role="tab"><a
                                        ...
                                        <div class="p-0 pb-2 border-0 card-header" id="headingThree" role="tab">
                            ...
                            <li class="col-md-4">
                                <h6 class="mb-1 dropdown-menu-header text-uppercase"><i class="la la-envelope-o"></i>
                                    Contact Us</h6>
                                    ...
                                    <div class="form-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="position-relative has-icon-left">
                                                    ...
                                                    <div class="pl-1 form-control-position"><i class="la la-user"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="position-relative has-icon-left">
                                                    ...
                                                    <div class="pl-1 form-control-position"><i
                                        ...
                                        <div class="row">
                                            <div class="mb-1 col-sm-12">
                                                <button class="float-right btn btn-info" type="button"><i
                ...
                <ul class="float-right nav navbar-nav">
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><i class="flag-icon @if(Config::get('app.locale') == 'ar') flag-icon-eg  @else flag-icon-gb @endif "></i><span
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span class="float-right m-0 notification-tag badge badge-default badge-warning">4
                                    New</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
                                <a href="javascript:void(0)">
