                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('dashboard.purches_invoices.store') }}"
                                        ...
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="type" id="invoiceType">
                                                            <optgroup label="نوع الفاتورة">
                                                                <option @if (old('type')=='فاتورة مؤقتة' ) selected
                                                                    @endif value="فاتورة مؤقتة"> فاتورة مؤقتة
                                                                </option>
                                                                @can('official_purches_invoices')
                                                                <option @if (old('type',$type)=='فاتورة رسمية' )
                                                                    selected @endif value="فاتورة رسمية"> فاتورة رسمية
                                                                </option>
                                                                @endcan
                                                            </optgroup>
                                                        </select>
                                            ...
                                            {{-- <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="text" id="userinput1" class="form-control"
                                            ...
                                            @livewire('dashboard.purches-invoice-create')
                                        </div>
