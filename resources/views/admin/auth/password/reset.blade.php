                    ...
                    <div class="p-0 col-md-4 col-10 box-shadow-2">
                        <div class="px-2 py-2 m-0 card border-grey border-lighten-3">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal" method="POST" action="{{ route('dashboard.password.reset.post') }}">
                                        @csrf
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="hidden" name="email" value="{{ $email }}">
                                            <input type="password" class="form-control form-control-lg input-lg"
                                                id="user-email" name="password" placeholder="Enter Password" required>
                                                @error('password')
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control form-control-lg input-lg"
                                                id="user-email" name="confirm-password" placeholder="Confirm Password" required>
