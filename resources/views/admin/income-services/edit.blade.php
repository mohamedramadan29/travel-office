        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block"> ادارة الإيرادات </h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#"> تعديل ايرادات  </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل ايرادات  </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="POST"
                                            action="{{ route('dashboard.income_services.update',$income->id) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> حدد  تصنيف الإيرادات    </label>
                                                            ...
                                                            <select name="safe_id" id="" class="form-control">
                                                                ...
                                                                @foreach ($safes as $safe)
                                                                    <option value="{{ $safe->id }}"
                                                                        {{ old('safe_id',$income->safe_id) == $safe->id ? 'selected' : '' }}>
                                                                        {{ $safe->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" id="" cols="30" rows="5" class="form-control">{{ old('description',$income->description) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
