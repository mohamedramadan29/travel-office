...
@section('title', ' طباعة ايراد خارجي ')
@section('content')
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block"> طباعة ايراد خارجي </h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.welcome') }}">الرئيسية</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.income_services.index') }}">
                                        الايرادات الخارجة </a>
                                </li>
                                <li class="breadcrumb-item active"> طباعة ايراد خارجي
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-body">
                <input type="hidden" value="{{ $income->category->name ?? 'غير محدد' }}" id="customername">
                <section class="card">
                        ...
                        <div id="invoice-company-details d-flex" class="row">
                            <div class="text-left col-12">
                                <div class="media-new" style="text-align: center">
                                    ...
                                    <h5 style="margin-top: 20px;font-weight: bold;"> طباعة ايراد خارجي </h5>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="table-responsive col-sm-12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{{ $income->category->name ?? 'غير محدد' }}</td>
                                                <td>{{ $income->price }} دينار </td>
                                                <td>
                                                    {{ $income->safe->name }}
                                                </td>
