<div class="text-left modal fade" id="addtransaction{{ $supplier->id }}" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel2">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel2">
                    <i class="la la-road2"></i> اضافة دفعة الي المورد
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{ route('dashboard.supplier.add_transaction', $supplier->id) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <input class="form-control" type="text" disabled readonly value="{{ $supplier->name }}">
                    </div>
                    <div class="form-group">
