                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.income_services_categories.index') }}"> التصنيفات
                                    </a>
                                </li>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="POST"
                                            action="{{ route('dashboard.income_services_categories.update', $category->id) }}">
                                            @csrf
                                            @method('PUT')
